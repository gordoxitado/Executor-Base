...
namespace Update {
    namespace LuaVM {
        const uintptr_t LuaO_NilObject = REBASE(0x463F5F8); // Done
        const uintptr_t LuaH_DummyNode = REBASE(0x463ED28); // Done
        const uintptr_t Luau_Execute = REBASE(0x26DB300);// Done
    }
}